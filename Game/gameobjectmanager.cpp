...
std::vector<std::shared_ptr<GameBuildingBase> > GameObjectManager::getBuildings()
{
    return buildings;
}
...
void GameObjectManager::addBuilding(std::shared_ptr<Game::GameBuildingBase> building)
{
